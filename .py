...
if selected == "About":
    ...
    st.markdown('''**Hello! I'm Arun, a Mechanical engineering graduate with a keen interest in data science and analytics.
                Currently on an exciting journey into the world of data science...**''')
    st.link_button('Linkedin','https://www.linkedin.com/in/arun-m-j17/') 
